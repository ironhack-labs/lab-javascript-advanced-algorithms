...
// let addQueueBtn = document.getElementById("add").addEventListener("click", addItem);
// let takeQueueBtn = document.getElementById("take").addEventListener("click", takeItem);
// let valueQueue = "";
// let valueSQueueList= "";
